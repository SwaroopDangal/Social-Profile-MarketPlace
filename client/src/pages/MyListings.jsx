    ...
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8">
      ...
      {userListings.length === 0 ? (
        <div className="bg-white rounded-lg border border-gray-200 p-16 text-center">
          ...
          <button
            onClick={() => navigate("/create-listing")}
            className="bg-indigo-600 hg:bg-indigo-700 text-white px-6 py-2 rounded-lg font-medium"
          >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-200">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <button
                        className="p-2 border border-gray-300 rounded-lg hover:bg-bg-gray-50 hover:text-purple-600"
      ...
      {showcredentialSubmsion && (
        <CredentialSubmission
          listing={showcredentialSubmsion}
      ...
      <div className="bg-white border-t border-gray-200 p-4 text-center mt-28">
        <p className="text-sm text-gray-500">
          Copyright &copy; {new Date().getFullYear()} <span>FlipEarn</span>. All
          rights reserved.
        </p>
      </div>
    </div>
