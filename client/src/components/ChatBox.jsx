          ...
          >
            <div className="flex items-end space-x-2">
              ...
              <button
                ...
                type="submit"
                className="bg-indigo-600 hover;bg-indigo-700 text-white p-2.5 rounded-lg disabled:opacity-55 transition-colors"
              >
                {isSending ? (
                  <Loader2Icon className="w-5 h-5 animate-spin rota" />
                ) : (
                  <Send className="w-5 h-5 rotate-48" />
                )}
              </button>
            </div>
          </form>
